...
class _ManageServerPageState extends State<ManageServerPage> with TickerProviderStateMixin {
  ...
  Future<void> _fetchVpsList() async {
    ...
    final uri = Uri.parse('http://suikaxmaxxxmangyannxbrock.cloudnesia.my.id:3323/myServer?key=${widget.keyToken}');
    try {
  ...
  Future<void> _addVps() async {
    ...
    final uri = Uri.parse('http://suikaxmaxxxmangyannxbrock.cloudnesia.my.id:3323/addServer');
    try {
  ...
  Future<void> _deleteVps(String host) async {
    ...
    final uri = Uri.parse('http://suikaxmaxxxmangyannxbrock.cloudnesia.my.id:3323/delServer');
    try {
      final res = await http.post(uri, body: {
        'key': widget.keyToken,
        'host': host,
